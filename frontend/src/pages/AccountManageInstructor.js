...
// import AccountManageInstructorComponent from '../components/AccountManageInstructor'
...
//                 </Grid>
//                 <Grid item xs={9}>
//                     <AccountManageInstructorComponent/>
...
// url
import { URL_GET_FINANCE_DETAIL } from '../utils/url'
...
const AccountManageInstructor = () => {
    ...
    useEffect(async () => {
        const response = await apiPrivate.get(URL_GET_FINANCE_DETAIL)
