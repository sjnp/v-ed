...
export const URL_GET_ASSIGNMENTS_COURSE = '/api/instructors/course/{courseId}/assignments'
export const URL_GET_POSTS_COURSE = '/api/instructors/course/{courseId}/posts'
export const URL_GET_REVIEWS_COURSE = '/api/instructors/course/{courseId}/reviews'
