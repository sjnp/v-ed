...
public class SaveCoursePictureUrlIT {
  @Autowired
  ...
  @Test
  void givenValidCourseIdAndObjectName_whenSaveCoursePictureUrl_ReturnPictureUrl() throws Exception {
    //given
    long courseId = createdCourseId;
    String objectName = "course_pic_" + courseId + ".jpeg";

    //when
    ResultActions resultActions = mockMvc
        .perform(put("/api/instructors/incomplete-courses/" + courseId + "/picture/" + objectName)
            .header(AUTHORIZATION, accessToken));
