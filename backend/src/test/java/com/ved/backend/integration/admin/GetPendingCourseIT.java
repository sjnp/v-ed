...
public class GetPendingCourseIT {
  @Autowired
  ...
  @Test
  void givenCourseId_whenGetPendingCourse_thenReturnPendingCourseInfo() throws Exception {
    // given
    long courseId = createdCourseId;

    // when
    ResultActions resultActions = mockMvc
        .perform(get("/api/admins/pending-courses/" + courseId)
